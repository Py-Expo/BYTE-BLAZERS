...
def call_chatgpt_api(message):
   ...
   "Skill Labs at kgisl institute of technology": "The Skill Labs at KGiSL Institute of Technology encompass various cutting-edge technologies such as Augmented Reality (AR), Virtual Reality (VR), and Robotic Process Automation (RPA). These labs provide students with hands-on experience and practical training in these emerging fields, preparing them for the challenges of the future.",
    ...
    "Transport details at kgisl institute of technology": "At KGiSL Institute of Technology, we ensure seamless transportation for students from various parts of Coimbatore and beyond, prioritizing safety and punctuality. Here are the details of our college bus routes  TransportWe ferry students from all parts of Coimbatore and beyond. We are on time, every time. We facilitate connectivity to student homes and drive them safe.COLLEGE BUS ROUTE AND FEE DETAILS Route No : 1 - Sirumugai - Reyon Nagar to KGiSL CampusRoute No : 2 - CTC METTUPALAYAM to KGiSL Campus Route No : 3 - Batharakaliamman Temple to KGiSL Campus  Route No : 4 - Jothipuram to KGiSL Campus  Route No : 5 - Bharathiar University to KGiSL CampusRoute No : 6 - Kannappan Nagar to KGiSL Campus  Route No : 7 - Kuniyamuthoor to KGiSL Campus    Route No : 8 - Sulur to KGiSL Campus   Route No : 9 - Tirupur to KGiSL Campus  Route No : 10 - Alanthurai to KGiSL Campus  Route No : 11 - Bhavanisagar to KGiSL Campus  Route No : 12 - Annur to KGiSL Campus Route No : 13 - Thadagam to KGiSL Campus",
